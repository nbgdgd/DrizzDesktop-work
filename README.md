...
У каждой реакции свой приоритет, срок жизни и cooldown. Очереди старых реплик нет. Обычные реплики по умолчанию не чаще раза в 7 минут; недавние фразы не повторяются. После временной реакции используется текущее базовое состояние. Claude/Aqua двигаются и говорят реже, Nezuko активнее; Drizz — основной дерзкий вариант.
